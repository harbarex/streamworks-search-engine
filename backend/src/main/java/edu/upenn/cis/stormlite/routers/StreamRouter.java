...
public abstract class StreamRouter implements OutputFieldsDeclarer {
	...
	/**
	 * Add a multijob sender bolt instance
	 * 
	 * @param bolt
	 */
	public void addRemoteBolt(MultiJobSenderBolt bolt) {
		bolts.add(bolt);
		remoteBolts.add(bolt);
	}
	...
	/**
	 * Execute a routing task for a tuple, ONLY sending to local bolt executors and
	 * NOT to remote ones
	 * 
	 * @param tuple          Tuple to route
	 * @param context        Overall context
	...
	/**
	 * Process a tuple with fields. Will send both to remote and local node
	 * executors.
	 * 
	 * @param tuple          Tuple to route
	 * @param context        Overall context
	...
	/**
	 * Executes all executor bolts, local and remote, with an end of stream message.
	 * Note
	...
	/**
	 * Executes all executor bolts on the local machine, with an end of stream
	 * message. Note
	 * that EOSes are always broadcast, independent of the grouping policy.
	 * 
	 * @param context        Overall context
