...
public class IndexMapBolt implements IRichBolt {
	static Logger log = LogManager.getLogger(IndexMapBolt.class);
	...
	public void prepare(Map<String, String> stormConf,
		...
		log.debug("(IndexMapBolt) Index: " + stormConf.get("workerIndex")
	...
	public synchronized boolean execute(Tuple input) {
		...
		if (!input.isEndOfStream()) {
			...
			// line format: [line / context, docID, tagName]
			String[] value = (String[]) input.getObjectByField("value");

			log.debug(getExecutorId() + " received " + key + " / " + value.toString() + " from executor "
