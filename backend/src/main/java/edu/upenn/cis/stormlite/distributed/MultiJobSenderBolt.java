 ...
 *
 */
public class MultiJobSenderBolt implements IRichBolt {

	static Logger log = LogManager.getLogger(MultiJobSenderBolt.class);
	...
	public MultiJobSenderBolt(String address, String stream, String id) {
		this.stream = stream;
	...
	public void prepare(Map<String, String> stormConf,
		...
		try {
			url = new URL(address + "/pushdata/" + jobID + "/" + stream);
