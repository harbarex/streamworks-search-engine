...
public class MultiJobRunJobRoute implements Route {
    static Logger log = LogManager.getLogger(MultiJobRunJobRoute.class);
    MultiJobDistributedCluster cluster;

    public MultiJobRunJobRoute(MultiJobDistributedCluster cluster) {
